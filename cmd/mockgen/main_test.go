...
// TestImpl3 tests package aliases
...
type fixtureImpl4 struct {
	ser1 *MockService2_3
}

// AssertExpectations asserts that everything specified with On and Return was in fact called as expected. Calls may have occurred in any order.
func (f *fixtureImpl4) AssertExpectations(t *testing.T) {
	f.ser1.AssertExpectations(t)
}

// createFixtureImpl4 creates a new fixture with all mocks
func createFixtureImpl4() (*impl4, *fixtureImpl4) {
	ser1 := new(MockService2_3)
	fixture := &impl4{ser1: ser1}
	return fixture, &fixtureImpl4{ser1: ser1}
}

type MockService2_3 struct {
	mock.Mock
}

func (m *MockService2_3) AssertFooNotCalled(t *testing.T, param *pkg2.MyInput) {
	m.AssertNotCalled(t, "Foo", param)
}
func (m *MockService2_3) Foo(param *pkg2.MyInput) *pkg2.MyOutput {
	ret := m.Called(param)
	return ret.Get(0).(*pkg2.MyOutput)
}
func (m *MockService2_3) OnFoo(param *pkg2.MyInput) *setup_MockService2_3_Foo {
	call := m.On("Foo", param)
	return &setup_MockService2_3_Foo{call: call}
}

type setup_MockService2_3_Foo struct {
	call *mock.Call
}

func (s *setup_MockService2_3_Foo) Return(param1 *pkg2.MyOutput) {
	s.call.Return(param1)
}
`
	mocks := []string{
...
type fixtureImpl5 struct {
	ser1 *MockService2_1
}

// AssertExpectations asserts that everything specified with On and Return was in fact called as expected. Calls may have occurred in any order.
func (f *fixtureImpl5) AssertExpectations(t *testing.T) {
	f.ser1.AssertExpectations(t)
}

// createFixtureImpl5 creates a new fixture with all mocks
func createFixtureImpl5() (*impl5, *fixtureImpl5) {
	ser1 := new(MockService2_1)
	fixture := &impl5{ser1: ser1}
	return fixture, &fixtureImpl5{ser1: ser1}
}
